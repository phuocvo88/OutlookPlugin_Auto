...
"display name|store type|path for a .pst or .ost|cached Exchange store|.pst or .ost|Instant Search enabled|store is open|store id|OOF set|Warning quota|Send quota|Receive quota|Current size|Free space|Max submit size|Conversion enabled")
