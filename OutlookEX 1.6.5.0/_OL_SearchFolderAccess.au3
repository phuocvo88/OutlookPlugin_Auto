...
; Access the first searchfolder found and display all items
; *****************************************************************************
...
If $aSearchFolders[0][0] = 0 Then Exit MsgBox($MB_ICONERROR, "OutlookEX UDF: _OL_SearchFolderAccess Example Script", "No searchfolders found!")
